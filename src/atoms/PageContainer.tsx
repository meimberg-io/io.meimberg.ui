...
/**
 * PageContainer-Atom — kanonischer Wrapper für jede Top-Level-Page.
 *
 ...
 * **kein** Padding. Wer eine Page baut, wrapt sie in genau einen
 * `<PageContainer>`. Kein Stack mit weiteren `p-*`-Wrappern.
 *
 * Das Klassen-Bündel `max-w-[1440px]` lebt ausschließlich in diesem Atom
 * (Drift-Schutz via ESLint `no-restricted-syntax`).
 *
 * @example
 *   <PageContainer>
 *     <h1>…</h1>
