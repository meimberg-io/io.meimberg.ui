...
export type InfoBannerVariant = keyof typeof VARIANT_CLASSES

export interface InfoBannerProps
  extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> {
  /** Fläche der Box. `muted` (Default) = `bg-muted/40`, `subtle` = `bg-card`. */
 ...
 *   <InfoBanner variant="subtle" italic={false}>No more tags available.</InfoBanner>
 */
export function InfoBanner({variant = 'muted', italic = true, className, children, ...rest}: InfoBannerProps) {
  return (
    <div
      className={cn(
