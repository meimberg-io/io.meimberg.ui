...
const groups: SidebarNavGroup[] = [
  {
    ...
    items: [
      ...
      {label: 'Projects', href: '/projects', icon: <FolderKanban className="h-4 w-4" />, badge: <CounterPill size="compact">5</CounterPill>},
      {label: 'Tasks', href: '/tasks', icon: <ListTodo className="h-4 w-4" />, badge: <CounterPill size="compact">12</CounterPill>},
    ],
  },
  {
